...
- Install the Axe developer tools extension for [Chrome](https://chromewebstore.google.com/detail/axe-devtools-web-accessib/lhdoppojpmngadmnindnejefpokejbdd)- or [Firefox](https://addons.mozilla.org/en-US/firefox/addon/axe-devtools/)-based browsers

### To prepare for the narrative project...

- Set up your story map project
  - Fork the [repository](https://github.com/Weitzman-MUSA-JavaScript/story-map-project)
