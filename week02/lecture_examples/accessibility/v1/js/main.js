...
function initLegend() {
  ...
  legend.onAdd = (map) => {
    ...
    div.id = 'map-legend';
    div.setAttribute('aria-labelledby', 'legend-title');
    div.setAttribute('role', 'region');
    div.setAttribute('aria-roledescription', 'Legend');
    ...
    div.innerHTML = `
      <h2 id="legend-title">Racial Classifications</h2>
      ...
      <h2><label for="majority-threshold">Majority Threshold</label>: <span id="majority-threshold-display">50%</span></h2>
